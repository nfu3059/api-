...
3. 用户需要合成人像作创意制作
## （八）人工智能概率性
1. 人脸美容技术出错的概率较小，但是因为不大一致的审美因此需要设置一定的选择参数
2. 人体抠像技术的边缘处理不错，主要缺点是不能精准定位需要抠图的人体
3.  人脸融合在不同性别的融合时表现出生硬和无过度，性别不明
4. 无限天空技术处于测试版，对于天空边界的检测出错性相对较高，容易超出边缘。
## （九）使用者交互与设计（axure产品原型）
* 产品架构
...
### API代码文档
[1.人体抠像和base64转换](http://nfunm059.gitee.io/index/)
[2.人脸美颜](http://nfunm059.gitee.io/index2)
